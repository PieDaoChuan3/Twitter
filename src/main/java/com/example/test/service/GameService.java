...
import com.example.test.entity.response.Game;
import java.util.Arrays;
import java.util.List;
import java.util.*;

import com.example.test.entity.db.Item;
import com.example.test.entity.db.ItemType;

@Service("PGameService")
public class GameService {
    private static final String TOKEN = "Bearer jm2ng4lz3lkjme867oe6es0gyt3hym";
    private static final String CLIENT_ID = "qgv55plmd4abhe6w2pl9dfigjbqh2i";
